...
function App() {
  ...
  useEffect(() => {
    ...
    async function requestPermissionAndToken() {
      try {
        console.log("백엔드 url", import.meta.env.VITE_BASE_URL);
  ...
  return (
    ...
    <div className="flex flex-col relative">
      <div className="font-diphylleia fixed h-screen w-screen grid grid-rows-[auto_1fr] overflow-hidden select-none cursor-default"
      ...
      <footer className="fixed bottom-0 left-0 w-full z-999">
        <Footer />
      </footer>
    </div>
  );
