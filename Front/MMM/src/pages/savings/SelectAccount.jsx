...
const SelectAccount = () => {
  ...
  return (
    <div className="min-h-0 flex flex-col overflow-hidden flex-1 pb-[60px]">
      ...
      <div className="p-8 w-full mx-auto rounded-[60px] bg-white z-10 -mt-23 flex justify-center items-center flex-col overflow-hidden">
        ...
        <form
          className="flex items-center px-5 h-10 mt-5 text-xl bg-blue-400 rounded-3xl shadow-xl"
